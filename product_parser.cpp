 ...
 */
//plan: makeProduct is given to us so use that and add the specific data mems for each type of product
//dynamic alloc with new (MEMORY USE HERE BE AWARE) call constructor
//also pass it the category of the type of product (derived class title)
